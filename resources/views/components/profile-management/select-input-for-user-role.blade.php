@props(['label','error' => '', 'roles' => [],])

<div class="sm:col-span-9">
    <div wire:ignore class="mb-4">
        <!-- Select -->
        <select {{ $attributes }} id="multiple-with-conditional-counter-select-role" multiple="" {{ count($roles) < 1 ? 'disabled' : '' }} data-hs-select='{
                    "placeholder": "{{ $label }}",
    ...
    @if(count($roles) > 0 && !request()->routeIs('user.show'))
