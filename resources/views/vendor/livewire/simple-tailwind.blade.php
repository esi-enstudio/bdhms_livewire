            ...
            <div class="flex items-center gap-2">
                <span>
                    @if ($paginator->onFirstPage())
                        <span class="relative py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-300 shadow-sm focus:outline-none focus:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-500 dark:hover:bg-neutral-800 cursor-not-allowed">
                ...
                <span>
                    @if ($paginator->hasMorePages())
                        ...
                        @endif
                    @else
                        <span class="relative py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-300 shadow-sm dark:bg-transparent dark:border-neutral-700 dark:text-neutral-500 cursor-not-allowed">
                            Next
                                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                        </span>
                    @endif
