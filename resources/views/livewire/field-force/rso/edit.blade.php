<div>
    <x-form
            heading="Update Rso Information"
            subheading="Modify the details of the RS0 below to ensure all information is accurate and up to date."
...
//                'url' => route('houses.edit', 5), // required if button type is 'link'
    ...
    >
        ...
        <x-form.section title="Assign House and User">
            ...
            <x-form.select-input-sm wire:model.live="form.user_id" error="form.user_id">
        ...
        <x-form.section title="Employment Information">
            ...
            <x-form.file-upload wire:model.blur="form.documents" error="form.documents" accept="application/pdf" :download_attchment="$document"/>
        </x-form.section>
