                                                    ...
                                                    <div id="users-accordion-sub-1-child" class="pl-4 hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden" role="region" aria-labelledby="users-accordion-sub-1">
                                                        <ul class="pt-1 space-y-1">
                                                            @foreach($firstLevelMenu['children'] as $secondLevelMenu)
                                                                <li>
                                                                    <a wire:navigate class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg dark:hover:bg-neutral-700 hover:bg-gray-100 focus:outline-none focus:bg-neutral-700 dark:bg-neutral-800 dark:text-neutral-200" href="{{ route($secondLevelMenu['route']) }}">
